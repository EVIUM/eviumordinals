      ...
      list: [
{
          ...
          name: "EVIUM",
          desc:
            "Get ready to explore a whole new universe! ✨ Click the circles to read the legend.",
          img:
            "https://raw.githubusercontent.com/EVIUM/eviumweb/main/assets/img/roadmap.png",
          thumbImg:
          ...
          name: "Legend",
          desc:
            "Some time after the birth of the universe, a large rogue planet originating from interstellar space, EVIUM was pulled into the orbit of a large gas giant. EVIUM, rich in minerals and rare elements, attained a non-toxic biosphere with liquid water and the a god flower, Soltheos emerged from the surface. Soltheos developed sentience and closely observed the cosmos above its new home in the universe, absorbing all useful information and storing it in genetic bits. Over billions of years of stargazing, the god absorbed enough solar energy and mystical energies from the gas giant above. Soltheos generated genetic code for lifeforms to explore the world as hunter gatherers. Soltheos gave rise to 7 energy types which became: Alpha, Beta, Gamma, Delta, Phi, Psi, and Omega, and assigned Delta as its own energy group. 154 energy seeds spawned from the flower, from which EVIUM lifeforms were born.",
          img:
            "https://raw.githubusercontent.com/EVIUM/eviumweb/main/assets/img/mmorpg.png",
          thumbImg:
            "https://raw.githubusercontent.com/EVIUM/eviumweb/main/assets/img/mmorpg.png"
        },
          {
        ...
        },
        {
          name: "Beta",
          desc:
            "β BETA Energy is the secondary energy of EVIUM. Beta Energy is provided by the water that flows through EVIUM. Beta energy flows through every EVIUM creature as they are all composed of mainly water. Beta energy flows from ancient oceans that originated in deep space before EVIUM was pulled into orbit in its new solar system. Beta EVIUM are hydrodynamic and have extraordinary health levels which is beneficial when creating a powerful EVIUM clan.",
          img:
        ...
        },
        {
          name: "Delta",
          desc:
            "Δ DELTA Energy is the flora and fauna energy that is essential for life to exist on EVIUM. Delta energy EVIUM are mostly pollinators who maintain the ecosystem and pollinate the flowers. Delta energy EVIUM can pack a serious venomous attack, even when they may be small in stature. Delta EVIUM are highly efficient at working together in large numbers. A clan containing many Delta EVIUM can become the most streamlined and productive clan.",
          img:
        ...
        },
        {
          name: "Omega",
          desc:
            "Ω OMEGA Energy is the final energy form of EVIUM. Omega energy EVIUM posses the ability to generate naturally occurring bio armour on their bodies, which equips them with a defensive advantage in combat and exploration. Omega EVIUM are explorers who are exceptional at finding resources in the wild. Omega EVIUM are staunch, dependent creatures who provide the ultimate support and reinforcement in a clan.",
          img:
